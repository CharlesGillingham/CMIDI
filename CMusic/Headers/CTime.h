...
// All math in CTime is done with SInt64s, so that we don't have to worry about numeric issues such as integer conversions, floating point errors or overflow into the negatives.
